          ...
          <div class="layout-content-container flex flex-col max-w-[960px] flex-1">
            <div class="flex flex-wrap justify-between gap-3 p-4">
              <div class="flex min-w-72 flex-col gap-3">
                <p class="text-[#1C160C] text-4xl font-black leading-tight tracking-[-0.033em]">Applications</p>
                <p class="text-[#A18249] text-base font-normal leading-normal">You have 3 applications in progress</p>
              </div>
            </div>
            <div class="px-4 py-3">
            ...
            <div class="flex gap-3 p-3 overflow-x-hidden">
              <div class="cursor-pointer flex h-8 shrink-0 items-center justify-center gap-x-2 rounded-full bg-[#F4EFE6] pl-4 pr-4">
                <p class="text-[#1C160C] text-sm font-medium leading-normal">All applications</p>
              </div>
              <div class="cursor-pointer flex h-8 shrink-0 items-center justify-center gap-x-2 rounded-full bg-[#F4EFE6] pl-4 pr-4">
                <p class="text-[#1C160C] text-sm font-medium leading-normal">In progress</p>
              </div>
              <div class="cursor-pointer flex h-8 shrink-0 items-center justify-center gap-x-2 rounded-full bg-[#F4EFE6] pl-4 pr-4">
                <p class="text-[#1C160C] text-sm font-medium leading-normal">Unread</p>
              </div>
              <div class="cursor-pointer flex h-8 shrink-0 items-center justify-center gap-x-2 rounded-full bg-[#F4EFE6] pl-4 pr-4">
                <p class="text-[#1C160C] text-sm font-medium leading-normal">Rejected</p>
              </div>
              <div class="cursor-pointer flex h-8 shrink-0 items-center justify-center gap-x-2 rounded-full bg-[#F4EFE6] pl-4 pr-4">
                <p class="text-[#1C160C] text-sm font-medium leading-normal">Withdrawn</p>
              </div>
            </div>

            <div class="test-container h-[26rem] overflow-scroll">
              <div class="flex items-center gap-4 bg-[#FFFFFF] px-4 min-h-[72px] py-2">
                <div
                  ...
                  style='background-image: url("https://cdn.usegalileo.ai/sdxl10/350a8cc2-c489-42c2-8e5a-45f4340c80ae.png");'
                ></div>
                <div class="flex flex-col justify-center">
                  <p class="text-[#1C160C] text-base font-medium leading-normal line-clamp-1">The Academy of Alameda</p>
                  <p class="text-[#A18249] text-sm font-normal leading-normal line-clamp-2">Math Teacher at The Academy of Alameda</p>
                </div>
              </div>
              <div class="flex items-center gap-4 bg-[#FFFFFF] px-4 min-h-[72px] py-2">
                <div
                  class="bg-center bg-no-repeat aspect-square bg-cover rounded-full h-14 w-fit"
                  style='background-image: url("https://cdn.usegalileo.ai/sdxl10/a09971a9-89cf-4fb9-a9ab-708c4563afb9.png");'
                ></div>
                <div class="flex flex-col justify-center">
                  <p class="text-[#1C160C] text-base font-medium leading-normal line-clamp-1">The Academy of Alameda</p>
                  <p class="text-[#A18249] text-sm font-normal leading-normal line-clamp-2">Math Teacher at The Academy of Alameda</p>
              ...
              <div class="flex items-center gap-4 bg-[#FFFFFF] px-4 min-h-[72px] py-2">
                <div
                  class="bg-center bg-no-repeat aspect-square bg-cover rounded-full h-14 w-fit"
                  style='background-image: url("https://cdn.usegalileo.ai/sdxl10/befebdc9-a62a-4222-821d-97556c12b55b.png");'
                ></div>
                <div class="flex flex-col justify-center">
                  <p class="text-[#1C160C] text-base font-medium leading-normal line-clamp-1">The Academy of Alameda</p>
                  <p class="text-[#A18249] text-sm font-normal leading-normal line-clamp-2">Math Teacher at The Academy of Alameda</p>
              ...
              <div class="flex items-center gap-4 bg-[#FFFFFF] px-4 min-h-[72px] py-2">
                <div
                  class="bg-center bg-no-repeat aspect-square bg-cover rounded-full h-14 w-fit"
                  style='background-image: url("https://cdn.usegalileo.ai/sdxl10/43232438-f3fe-4d4e-93ab-834bc053584d.png");'
                ></div>
                <div class="flex flex-col justify-center">
                  <p class="text-[#1C160C] text-base font-medium leading-normal line-clamp-1">The Academy of Alameda</p>
                  <p class="text-[#A18249] text-sm font-normal leading-normal line-clamp-2">Math Teacher at The Academy of Alameda</p>
              ...
              <div class="flex items-center gap-4 bg-[#FFFFFF] px-4 min-h-[72px] py-2">
                <div
                  class="bg-center bg-no-repeat aspect-square bg-cover rounded-full h-14 w-fit"
                  style='background-image: url("https://cdn.usegalileo.ai/sdxl10/b8b0f0a0-b493-4353-bf66-aa56446b72ac.png");'
                ></div>
                <div class="flex flex-col justify-center">
                  <p class="text-[#1C160C] text-base font-medium leading-normal line-clamp-1">The Academy of Alameda</p>
                  <p class="text-[#A18249] text-sm font-normal leading-normal line-clamp-2">Math Teacher at The Academy of Alameda</p>
