...
if(!isset($_SESSION['id'])){
    header("location: ../schoolsdashboard.php");
}
$data = $_SESSION['data'];
?>
    ...
    <div class="relative flex size-full min-h-screen flex-col bg-[#FFFFFF] group/design-root overflow-x-hidden" style='font-family: "Plus Jakarta Sans", "Noto Sans", sans-serif;'>
      <div class="layout-container flex h-full grow flex-col">
        ...
        <div class="gap-1 px-5  mt-20 flex flex-1 justify-center py-5">
            ...
            <div class="flex h-full min-h-[700px] flex-col justify-between bg-[#FFFFFF] py-4">
              <div class="flex flex-col gap-4">
                ...
                <div class="flex flex-col gap-2">
                  <a href="schooldashboard.php" class="flex items-center gap-3 px-3 py-2 rounded-lg bg-[#F4EFE6] hover:rounded-lg hover:bg-[#F4EFE6] transition delay-150 duration-300">
          ...
          <div class="layout-content-container flex flex-col max-w-[960px] flex-1 px-5">
            <div class="flex flex-wrap justify-between gap-3 p-4">
              <div class="flex min-w-72 flex-col gap-3">
                <p class="text-[#1C160C] text-4xl font-black leading-tight tracking-[-0.033em]">Welcome, John Doe</p>
                <p class="text-[#798189] text-base font-normal leading-normal">You're the admin for the school. Here's an overview of your recruitment process.</p>
              </div>
            </div>
            <div class="flex flex-wrap gap-4 p-4">
              <div class="flex min-w-[158px] flex-1 flex-col gap-2 rounded-xl p-6 border border-[#E9DFCE]">
                <p class="text-[#1C160C] text-base font-medium leading-normal">Total Applications</p>
                <p class="text-[#1C160C] tracking-light text-2xl font-bold leading-tight">1200</p>
              </div>
              <div class="flex min-w-[158px] flex-1 flex-col gap-2 rounded-xl p-6 border border-[#E9DFCE]">
                <p class="text-[#1C160C] text-base font-medium leading-normal">Pending Applications</p>
                <p class="text-[#1C160C] tracking-light text-2xl font-bold leading-tight">500</p>
              </div>
              <div class="flex min-w-[158px] flex-1 flex-col gap-2 rounded-xl p-6 border border-[#E9DFCE]">
                <p class="text-[#1C160C] text-base font-medium leading-normal">Hires</p>
                <p class="text-[#1C160C] tracking-light text-2xl font-bold leading-tight">700</p>
              </div>
              <div class="flex min-w-[158px] flex-1 flex-col gap-2 rounded-xl p-6 border border-[#E9DFCE]">
                <p class="text-[#1C160C] text-base font-medium leading-normal">Retention Rate</p>
                <p class="text-[#1C160C] tracking-light text-2xl font-bold leading-tight">85%</p>
              </div>
            </div>
            <div class="flex flex-wrap gap-4 px-4 py-6">
              <div class="flex min-w-72 flex-1 flex-col gap-2">
                <p class="text-[#1C160C] text-base font-medium leading-normal">Application Timeline</p>
                <div class="flex min-h-[180px] flex-1 flex-col gap-8 py-4">
                  ...
                  <div class="flex justify-around">
                    <p class="text-[#798189] text-[13px] font-bold leading-normal tracking-[0.015em]">Jan</p>
                    <p class="text-[#798189] text-[13px] font-bold leading-normal tracking-[0.015em]">Feb</p>
                    <p class="text-[#798189] text-[13px] font-bold leading-normal tracking-[0.015em]">Mar</p>
                    <p class="text-[#798189] text-[13px] font-bold leading-normal tracking-[0.015em]">Apr</p>
                    <p class="text-[#798189] text-[13px] font-bold leading-normal tracking-[0.015em]">May</p>
                    <p class="text-[#798189] text-[13px] font-bold leading-normal tracking-[0.015em]">Jun</p>
                    <p class="text-[#798189] text-[13px] font-bold leading-normal tracking-[0.015em]">Jul</p>
                  </div>
                </div>
              </div>
