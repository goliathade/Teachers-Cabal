          ...
          <div class="layout-content-container flex flex-col max-w-[960px] flex-1">
            <div class="flex flex-wrap justify-between gap-3 p-4">
              <div class="flex min-w-72 flex-col gap-3">
                <p class="text-[#141414] text-4xl font-black leading-tight tracking-[-0.033em]">Applicants</p>
                <p class="text-[#3E4D5B] text-base font-normal leading-normal">Review and manage teacher applicant profiles</p>
              </div>
            </div>
            <div class="px-4 py-3">
            ...
            <div class="flex gap-3 p-3 flex-wrap pr-4">
              <select class="h-15 shrink-0 rounded-full bg-[#F0F2F5] pl-4 pr-8 text-[#141414] text-sm font-medium leading-normal">
            ...
            <div class="px-4 py-3 @container">
              <div class="flex overflow-scroll rounded-xl border border-[#DBE1E6] bg-[#FFFFFF] h-[24rem]">
                <table class="flex-1">
                  <thead>
                    <tr class="bg-[#FFFFFF]">
                      <th class="table-627f6882-bad0-4255-8f83-e93463565593-column-120 px-4 py-3 text-left text-[#141414] w-[400px] text-sm font-medium leading-normal">Role</th>
                      <th class="table-627f6882-bad0-4255-8f83-e93463565593-column-240 px-4 py-3 text-left text-[#141414] w-[400px] text-sm font-medium leading-normal">Name</th>
                      <th class="table-627f6882-bad0-4255-8f83-e93463565593-column-360 px-4 py-3 text-left text-[#141414] w-[400px] text-sm font-medium leading-normal">Email</th>
                      <th class="table-627f6882-bad0-4255-8f83-e93463565593-column-480 px-4 py-3 text-left text-[#141414] w-60 text-sm font-medium leading-normal">Stage</th>
                      <th class="table-627f6882-bad0-4255-8f83-e93463565593-column-600 px-4 py-3 text-left text-[#141414] w-[400px] text-sm font-medium leading-normal">
                        Location
                      </th>
                      <th class="table-627f6882-bad0-4255-8f83-e93463565593-column-720 px-4 py-3 text-left text-[#141414] w-[400px] text-sm font-medium leading-normal">Applied</th>
                      <th
                        class="table-627f6882-bad0-4255-8f83-e93463565593-column-840 px-4 py-3 text-left text-[#141414] w-60 text-[#3E4D5B] text-sm font-medium leading-normal"
                      ></th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr class="border-t border-t-[#DBE1E6]">
                      <td class="table-627f6882-bad0-4255-8f83-e93463565593-column-120 h-[72px] px-4 py-2 w-[400px] text-[#141414] text-sm font-normal leading-normal">
                        Elementary Teacher
                      </td>
                      <td class="table-627f6882-bad0-4255-8f83-e93463565593-column-240 h-[72px] px-4 py-2 w-[400px] text-[#141414] text-sm font-normal leading-normal">
                        Alice Wang
                      </td>
                      <td class="table-627f6882-bad0-4255-8f83-e93463565593-column-360 h-[72px] px-4 py-2 w-[400px] text-[#3E4D5B] text-sm font-normal leading-normal">
                        alice.wang@westsideacademy.org
                      </td>
                      <td class="table-627f6882-bad0-4255-8f83-e93463565593-column-480 h-[72px] px-4 py-2 w-60 text-sm font-normal leading-normal">
                        <button
                      ...
                      <td class="table-627f6882-bad0-4255-8f83-e93463565593-column-600 h-[72px] px-4 py-2 w-[400px] text-[#3E4D5B] text-sm font-normal leading-normal">
                        San Francisco, CA
                      </td>
                      <td class="table-627f6882-bad0-4255-8f83-e93463565593-column-720 h-[72px] px-4 py-2 w-[400px] text-[#3E4D5B] text-sm font-normal leading-normal">
                        2 days ago
                      </td>
                      <td class="table-627f6882-bad0-4255-8f83-e93463565593-column-840 h-[72px] px-4 py-2 w-60 text-[#3E4D5B] text-sm font-bold leading-normal tracking-[0.015em]">
                        View profile
                      </td>
                    </tr>
                    <tr class="border-t border-t-[#DBE1E6]">
                      ...
                      <td class="table-627f6882-bad0-4255-8f83-e93463565593-column-480 h-[72px] px-4 py-2 w-60 text-sm font-normal leading-normal">
                        <button
                          class="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-8 px-4 bg-[#F0F2F5] text-[#141414] text-sm font-medium leading-normal w-full"
                        >
                          <span class="truncate">Interview</span>
                        </button>
                      </td>
                      <td class="table-627f6882-bad0-4255-8f83-e93463565593-column-600 h-[72px] px-4 py-2 w-[400px] text-[#3E4D5B] text-sm font-normal leading-normal">
                        Los Angeles, CA
              ...
              <style>
                @container(max-width:120px){.table-627f6882-bad0-4255-8f83-e93463565593-column-120{display: none;}}
                @container(max-width:240px){.table-627f6882-bad0-4255-8f83-e93463565593-column-240{display: none;}}
                @container(max-width:360px){.table-627f6882-bad0-4255-8f83-e93463565593-column-360{display: none;}}
                @container(max-width:480px){.table-627f6882-bad0-4255-8f83-e93463565593-column-480{display: none;}}
                @container(max-width:600px){.table-627f6882-bad0-4255-8f83-e93463565593-column-600{display: none;}}
                @container(max-width:720px){.table-627f6882-bad0-4255-8f83-e93463565593-column-720{display: none;}}
                @container(max-width:840px){.table-627f6882-bad0-4255-8f83-e93463565593-column-840{display: none;}}
              </style>
            </div>
          </div>
        </div>
