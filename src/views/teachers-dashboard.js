          ...
          <div className="landing-page-depth2-frame0">
            ...
            <div className="teachers-dashboard-depth2-frame1">
              ...
              <div className="teachers-dashboard-dashboardmain">
                ...
                <div className="teachers-dashboard-profiletext">
                  <span className="teachers-dashboard-text23">Profile</span>
                </div>
                <div className="teachers-dashboard-profiletab">
                  <div className="teachers-dashboard-depth5-frame03">
                    <img
                      alt="Depth6Frame03829"
                      src="/external/depth6frame03829-xvuc.svg"
                      className="teachers-dashboard-depth6-frame012"
                    />
                    <div className="teachers-dashboard-depth6-frame12">
                      <span className="teachers-dashboard-text24">
                        Your profile
                      </span>
                      <span className="teachers-dashboard-text25">
                        Help schools get to know you better by filling out your
                        profile.
                      </span>
                    </div>
                  </div>
