                  ...
                  <div className="schooldashboardoverview-depth4-frame01">
                    <div className="schooldashboardoverview-depth5-frame02">
                      <div className="schooldashboardoverview-depth6-frame011">
                        ...
                        <a href='/schooldashboardhires' className="schooldashboardoverview-depth7-frame5 active">
                ...
                <div className="schooldashboardhires-depth4-frame1">
                  <div className="schooldashboardhires-depth5-frame04">
                    <div className="schooldashboardhires-depth6-frame015">
                      ...
                      <input type='text' className="schooldashboardhires-depth7-frame14" placeholder='Search for a hire...' />
                     
                    </div>
                  </div>
                </div>

                <div className='hiresContainer'>
