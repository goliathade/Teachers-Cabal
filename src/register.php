...
<html>
    ...
    <body style=" font-family: fantasy";>
        <center>
            ...
            <h1 style="color:black;">TEacher Registration</h1>
            </div>
            <hr>

            
                <form action="../ATS/api/register.php" method="POST" enctype="multipart/form-data">
                    ...
                    <input style="width: 19%" type="number" name="age" placeholder="Age" required><br><br>
                    ...
                    <span>School? Not Teacher</span> <a href="../ATS/schoolreg.php">Login here</a>
                </form>
            </center>
    </body>
</html>
