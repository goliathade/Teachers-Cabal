        ...
        <div class="gap-1 px-6 mt-20 flex flex-1 justify-center py-5">
            ...
            <div class="flex h-full min-h-[700px] flex-col justify-between bg-[#FFFFFF] py-4">
              ...
              <div class="flex flex-col gap-4">
                ...
                <div class="flex flex-col gap-2">
                  ...
                  <a href="TeacherHelp.php" class="flex items-center gap-3 px-3 py-2 rounded-lg bg-[#F4EFE6] hover:rounded-lg hover:bg-[#F4EFE6] transition delay-150 duration-300">
          ...
          <div class="layout-content-container flex flex-col max-w-[960px] flex-1">
            <div class="flex flex-wrap justify-between gap-3 p-4">
              <p class="text-[#141414] text-4xl font-black leading-tight tracking-[-0.033em] min-w-72">Help and Support</p>
            </div>
            <div class="px-4 py-3">
              <label class="flex flex-col min-w-40 h-12 w-full">
                <div class="flex w-full flex-1 items-stretch rounded-xl h-full">
                  ...
                  <input
                    placeholder="Search help topics, FAQs, resource links..."
                    class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-xl text-[#141414] focus:outline-0 focus:ring-0 border-none bg-[#F0F2F5] focus:border-none h-full placeholder:text-[#3E4D5B] px-4 rounded-l-none border-l-0 pl-2 text-base font-normal leading-normal"
                    value=""
                  />
                </div>
            ...
            <h2 class="text-[#141414] text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5">Popular help topics</h2>
            <div class="flex items-center gap-4 bg-[#FFFFFF] px-4 min-h-14 cursor-pointer">
              <div
                class="text-[#141414] flex items-center justify-center rounded-lg bg-[#F0F2F5] shrink-0 size-10"
                data-icon="ArrowCircleUp"
                data-size="24px"
                data-weight="regular"
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
              ...
              <p class="text-[#141414] text-base font-normal leading-normal flex-1 truncate">How to write a job posting</p>
            </div>
            <div class="flex items-center gap-4 bg-[#FFFFFF] px-4 min-h-14 cursor-pointer">
              <div
                class="text-[#141414] flex items-center justify-center rounded-lg bg-[#F0F2F5] shrink-0 size-10"
              ...
              <p class="text-[#141414] text-base font-normal leading-normal flex-1 truncate">How to manage candidates</p>
            </div>
            <div class="flex items-center gap-4 bg-[#FFFFFF] px-4 min-h-14 cursor-pointer">
              <div
                class="text-[#141414] flex items-center justify-center rounded-lg bg-[#F0F2F5] shrink-0 size-10"
              ...
              <p class="text-[#141414] text-base font-normal leading-normal flex-1 truncate">How to send an offer</p>
            </div>
            <div class="flex items-center gap-4 bg-[#FFFFFF] px-4 min-h-14 cursor-pointer">
              <div
                class="text-[#141414] flex items-center justify-center rounded-lg bg-[#F0F2F5] shrink-0 size-10"
              ...
              <p class="text-[#141414] text-base font-normal leading-normal flex-1 truncate">How to set up billing</p>
            </div>
            <h2 class="text-[#141414] text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5">Still need help?</h2>
            <div class="flex items-center gap-4 bg-[#FFFFFF] px-4 min-h-[72px] py-2">
              <div class="text-[#141414] flex items-center justify-center rounded-lg bg-[#F0F2F5] shrink-0 size-12" data-icon="Envelope" data-size="24px" data-weight="regular">
                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                  <path
              ...
              <div class="flex flex-col justify-center">
                <p class="text-[#141414] text-base font-medium leading-normal line-clamp-1">Email us</p>
                <p class="text-[#3E4D5B] text-sm font-normal leading-normal line-clamp-2">
                  We're here to help. Email us at support@cantic.com and we'll get back to you as soon as possible.
                </p>
              </div>
            </div>
            <div class="flex items-center gap-4 bg-[#FFFFFF] px-4 min-h-[72px] py-2">
              <div class="text-[#141414] flex items-center justify-center rounded-lg bg-[#F0F2F5] shrink-0 size-12" data-icon="ChatCircle" data-size="24px" data-weight="regular">
                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                  <path
              ...
              <div class="flex flex-col justify-center">
                <p class="text-[#141414] text-base font-medium leading-normal line-clamp-1">Chat with us</p>
                <p class="text-[#3E4D5B] text-sm font-normal leading-normal line-clamp-2">
                  We're here to help. Email us at support@cantic.com and we'll get back to you as soon as possible.
                </p>
              </div>
            ...
            <div class="flex items-center gap-4 bg-[#FFFFFF] px-4 min-h-[72px] py-2">
              <div
                class="text-[#141414] flex items-center justify-center rounded-lg bg-[#F0F2F5] shrink-0 size-12"
                data-icon="CaretCircleRight"
                data-size="24px"
                data-weight="regular"
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
              ...
              <div class="flex flex-col justify-center">
                <p class="text-[#141414] text-base font-medium leading-normal line-clamp-1">Help center</p>
                <p class="text-[#3E4D5B] text-sm font-normal leading-normal line-clamp-2">Find answers to common questions in our help center.</p>
              </div>
            </div>
          </div>
        </div>
